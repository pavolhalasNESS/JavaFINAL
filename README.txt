...
GET http://localhost:8080/articles/{articleId} - returns single articleDTO with provided articleDTO ID

PUT http://localhost:8080/articles - creates a new articleDTO.
